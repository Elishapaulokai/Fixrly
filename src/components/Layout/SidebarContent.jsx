          ...
          <div className="mt-auto">
            ...
            <div className="p-4 border-b">
              ...
              >
                <SelectTrigger className="w-full card_bg border border-gray-300 dark:border-gray-600 rounded-lg">
                  <div className="flex items-center gap-2">
                    {!isLoadingLangs && !langError && (
                      <CustomImageTag
                        src={languages.find(lang => lang.langCode === selectedLanguage)?.image}
                ...
                <SelectContent className="z-[9999] min-w-[200px] card_bg border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg" onPointerDownOutside={() => setIsMobileLangOpen(false)}>
                  {isLoadingLangs ? (
                    <SelectItem value="loading" disabled className="flex items-center gap-2 py-3 px-4 text-gray-500">
                      <div className="w-4 h-4 border-2 border-gray-300 border-t-blue-500 rounded-full animate-spin"></div>
                      <span>{t("loading")}...</span>
                    </SelectItem>
                  ) : langError ? (
                    <SelectItem value="error" disabled className="flex items-center gap-2 py-3 px-4 text-red-500">
